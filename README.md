# aicp-priv_keys-template

# Usage

```bash
croot && git clone https://github.com/khargosxh18/vendor_aicp-priv_keys-template.git vendor/aicp-priv/keys
```

```bash
cd vendor/aicp-priv/keys
```
...
```
$ ./check_keys.py ~/aicp/out/target/product/lynx
